    ...
    <div className="relative flex h-screen w-full flex-row items-center justify-center py-16 md:h-auto">
      <div className="relative mx-auto size-full max-w-7xl overflow-hidden px-4 md:h-[40rem]">
        <motion.div
          ...
          className="div"
        >
          <div className="flex h-[40rem] flex-col items-center py-8">
            <h2 className="text-4xl font-bold text-neutral-900 dark:text-neutral-100">
              <TypewriterEffectSmooth words={words} />
            </h2>
            <p className="mx-auto max-w-md text-center text-base font-normal text-neutral-700 md:text-lg dark:text-neutral-200">
              Committed to open source and public goods. Leading the way in web3
              exploration, one data point at a time.
            </p>
          </div>
        </motion.div>
        <div className="pointer-events-none absolute inset-x-0 bottom-0 z-40 h-8 w-full select-none bg-gradient-to-b from-transparent to-white dark:to-black/80" />
        <div className="absolute -bottom-48 z-10 h-20 w-full md:h-full">
